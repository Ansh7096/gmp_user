...
export default function ApprovingAuthority() {
    ...
    const handleRevertSubmit = async (e) => {
        ...
        try {
            const res = await fetch(`${API_BASE_URL}/grievances/revert/${encodeURIComponent(selectedGrievance.ticket_id)}`, {
                method: 'PUT',
    ...
    const handleTransferSubmit = async (e) => {
        ...
        try {
            ...
            const refreshedGrievances = await fetch(`${API_BASE_URL}/grievances/escalated`).then(res => res.json());
